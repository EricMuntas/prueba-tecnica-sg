        ...
        <div class="max-w-6xl w-full mx-auto">
            ...
            <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
                <div>
                    ...
                    <h1 class="text-3xl font-bold text-white">Gestión de Subcategorías</h1>
                </div>
            ...
            <div class="relative">
                ...
                <SubCategoryTable v-else :subcategories="subcategories" :categories="categories"></SubCategoryTable>
            </div>
        </div>
    </div>
</template>